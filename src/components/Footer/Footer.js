                ...
                <div className="row border-top border-bottom">
                    <div className="col-md-12">
                        <div className="row">
                                ...
                                <div className="justify-content-center align-items-center pt-5 pb-5">
                                    <div>
                                        <Image
                                            ...
                                            width={10}
                                            height={50}
                                            className="card-img-top mb-4 white-image"
                                        />
                                        <p className='pt-2'>SINC Partners Lab is a SaaS and a Marketing Tech startup studio building platform-based products for solution-providers and entrepreneurs that will help democratize success.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-2 col-md-4 col-sm-6 col-12 mb-4">
                            ...
                            <div className="col-lg-2 col-md-4 col-sm-6 col-12 mb-4 border-left" style={{ borderLeft: '1px solid white' }}>
